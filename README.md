...
**Desktop / App Stack:** Electron (for Desktop version), React, TypeScript, Yarn, Jimp, Styled-Components;</br>
...
## :footprints: Available resources
...
You can check out the header format here: https://wiki.fileformat.com/audio/wav/
